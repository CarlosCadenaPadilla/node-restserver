...
//===========================//
app.get('/cuenta', verificaToken, (req, res) => {
...
//===========================//
app.get('/cuenta/:id', verificaToken, (req, res) => {
...
app.post('/cuenta', verificaToken, function (req, res) {
...
app.put('/cuenta/:id', verificaToken, function (req, res) {

    let id = req.params.id;
    
    let body = _.pick(req.body, ['nombre', 'numeroCuenta', 'naturalezaCuenta', 'estado', 'presupuesto']);
    //let body = req.body;
    ...
    // })
    Cuenta.findByIdAndUpdate(id, body, { new: true, runValidators: true }, (err, cuentaDB) => {
...
app.delete('/cuenta/:id', verificaToken, function (req, res) {
