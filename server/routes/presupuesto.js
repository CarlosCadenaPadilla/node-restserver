...
app.put('/presupuesto/:id', verificaToken, function (req, res) {
    ...
    let id = req.params.id;
    let body = _.pick(req.body, ['nombre', 'valorPresupuesto', 'fechaInicioPresupuesto', 'fechaFinPresupuesto']);

    Presupuesto.findByIdAndUpdate(id, body, { new: true, runValidators: true }, (err, presupuestoDB) => {
